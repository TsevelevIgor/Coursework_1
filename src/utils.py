...
def read_file(file):
    """Читает DataFrame, возвращает список словарей"""
    transactions = []
    ...
    try:
        ...
        logger.error("Error")
        print(f"We have a problem with a reading file: {e}")
...
def number_cards(trans, info):
    ...
    try:
        ...
        logger.error("Wrong numbers of cards")
        print(f"We have a problem with getting of numbers card: {e}")
...
def top_transactions(trans, info):
    ...
    try:
        ...
        logger.error("Error")
        print(f"We have a problem with top transactions: {e}")
...
def currency(info):
    ...
    try:
        ...
        logger.error("Error")
        print(f"We have a problem with currency: {e}")
...
def stock_prices(info):
    ...
    try:
        ...
        headers = {"x-rapidapi-key": access_key_stock,
        ...
        logger.error("Error")
        print(f"We have a problem with stocks: {e}")


def to_file(info):
    """Записываем словарь info в json файл, возвращаем словарь info"""
    try:
        ...
        print(f"We have a problem with recording to file: {e}")
